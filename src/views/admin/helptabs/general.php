<h3><img src="<?php echo $plugin->getGlobal('pluginUrl') . '/images/icon-wp-mailto-links.png' ?>" width="16" height="16" /> <?php echo get_admin_page_title() ?> - version <?php echo WPML_VERSION ?></h3>
