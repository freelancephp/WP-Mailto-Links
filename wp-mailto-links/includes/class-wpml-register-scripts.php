...
final class WPML_Register_Scripts extends WPRun_Base_1x0x0
{
    ...
    protected function register_scripts()
    {
        ...
        wp_register_style(
            'wpml-style'
            , plugins_url( '/public/css/wpel.css', WPML_Plugin::get_plugin_file() )
            , array()
            , $plugin_version
        );
        ...
        wp_register_style(
            'wpml-admin-style'
            , plugins_url( '/public/css/wpml-admin.css', WPML_Plugin::get_plugin_file() )
            , array()
            , $plugin_version
        );
        ...
        wp_register_script(
            'wpml-admin-script'
            , plugins_url( '/public/js/wpml-admin.js', WPML_Plugin::get_plugin_file() )
            , array( 'jquery' )
            , $plugin_version
            , true
        );
