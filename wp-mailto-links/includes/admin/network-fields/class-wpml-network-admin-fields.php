<?php
/**
 * Class WPML_Network_Admin_Fields
 *
 * @package  WPML
 ...
 */
final class WPML_Network_Admin_Fields extends FWP_Settings_Section_Base_1x0x0
{
    ...
    protected function init()
    {
        $this->set_settings( array(
            'section_id'        => 'wpml-network-admin-fields',
            'page_id'           => 'wpml-network-admin-fields',
            'option_name'       => 'wpml-network-admin-settings',
            'option_group'      => 'wpml-network-admin-settings',
            'title'             => __( 'Network Admin Settings', 'wp-mailto-links' ),
            'fields'            => array(
                'own_admin_menu' => array(
                    'label'         => __( 'Main Network Admin Menu:', 'wp-mailto-links' ),
                    'default_value' => '1',
                ),
            ),
        ) );
    ...
    protected function save_network_settings()
    {
        ...
        wp_redirect( add_query_arg(
            array(
                'page' => 'wpml-network-settings-page',
                'updated' => true
            )
            , $redirect_url
        ) );
    ...
    protected function show_own_admin_menu( array $args )
    {
        $this->get_html_fields()->check_with_label(
            $args[ 'key' ]
            , __( 'Create own network admin menu for this plugin', 'wp-mailto-links' )
            , '1'
            , ''
        );
