 ...
 */
final class WPML_Activation extends FWP_Register_Hook_Base_1x0x0
{
    ...
    {
        $network_already_set = get_site_option( 'wpml-network-settings' );
        ...
        $network_values = WPML_Network_Fields::get_instance()->get_default_values();
        $network_admin_values = WPML_Network_Admin_Fields::get_instance()->get_default_values();

        update_site_option( 'wpml-network-settings', $network_values );
        update_site_option( 'wpml-network-admin-settings', $network_admin_values );
    }
    ...
    protected function site_procedure()
    {
        ...
        update_option( 'wpml-version', $plugin_data[ 'Version' ] );
    }
