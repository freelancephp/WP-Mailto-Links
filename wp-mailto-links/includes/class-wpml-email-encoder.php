 ...
 */
final class WPML_Email_Encoder extends WPRun_Base_1x0x0
{
...
//    }
    ...
    public function pageFilter($content, $filterHead, $filterBody)
    {
        ...
        if ($filterBody === true) {
            $filteredBody = $this->contentFilter($htmlSplit[4]);
        } else {
